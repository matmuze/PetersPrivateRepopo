...
Transfer function based approaches are related as our data resembles volumetric data in the sense that it consists of a dense point cloud.
However, instead of continuous attribute values distributed over voxels, our data features a discrete number of molecule types. This characteristic enables our visibility equalizer approach.
